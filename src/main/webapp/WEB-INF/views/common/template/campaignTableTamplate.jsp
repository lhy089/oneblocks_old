...
<table class="table table-hover table-main">
	<thead>
		<tr>
			...
			<th style="width:32%;" scope="col"><a data-value="c" href="javascript:void(0);" onclick="campaignListOrder('c'); return false;" class="datatable-sorter">캠페인명</a></th>
			<th style="width:12%;" scope="col"><a data-value="o" href="javascript:void(0);" onclick="campaignListOrder('o'); return false;" class="datatable-sorter">On/Off</a></th>
			<th style="width:12%;" scope="col"><a data-value="p" href="javascript:void(0);" onclick="campaignListOrder('p'); return false;" class="datatable-sorter">판매가</a></th>
			<th style="width:12%;" scope="col"><a data-value="q" href="javascript:void(0);" onclick="campaignListOrder('q'); return false;" class="datatable-sorter">판매수량</a></th>
			<th style="width:12%;" scope="col"><a data-value="r" href="javascript:void(0);" onclick="campaignListOrder('r'); return false;" class="datatable-sorter">매출액</a></th>
			<th style="width:15%;" scope="col"><a data-value="u" href="javascript:void(0);" onclick="campaignListOrder('u'); return false;" class="datatable-sorter">업데이트</a></th>
		</tr>
  	</thead>
