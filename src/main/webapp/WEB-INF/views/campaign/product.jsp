...
<meta charset="UTF-8">
<title>원블록스</title>
<script src="../resources/js/campaign/product.js?t=<%= new java.util.Date() %>"></script>
<link href="../resources/css/campaign/product.css?t=<%= new java.util.Date() %>" rel="stylesheet" />
</head>
<body>
	<div class="card-body">
		<div
			...
			<table class="table table-hover table-main">
				  ...
				  <tbody class="table-group-divider" id="productTableDiv">
